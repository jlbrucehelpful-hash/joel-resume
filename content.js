window.RESUME = {
  ...
  roles: [
    {
      ...
      title: "Workplace Experience Specialist / IT Support",
    ...
    {
      company: "Network Technologies Queensland",
      title: "IT Technical Support / Service Desk Technician",
      period: "2021-2022",
      type: "Level 1/2 technical, systems and networking support",
      highlights: [
    ...
    },
    {
      ...
      period: "2020-2021",
      type: "ISP technical support and network diagnostics",
      highlights: [
        "Performed Layer 1-3 diagnostics, TCP/IP troubleshooting, router configuration and internet fault investigation.",
        "Used SSH, PuTTY, MobaXterm and Wireshark for connectivity checks, network monitoring and fault isolation.",
        "Managed customer incidents, coordinated NBN fault escalation and trained new technical support staff."
      ],
      tags: ["TCP/IP", "Wireshark", "SSH", "Routers", "Mentoring"]
    },
    {
      company: "Smile IT",
  ...
  certifications: [
    ["ITIL v4 Foundation Certificate in IT Service Management", "2025"],
    ["AWS Technical Essentials", "2024"],
    ["AWS Security Essentials", "2024"],
    ["Jamf 100 Certificate", "2024"],
    ["Diploma of Information Technology Networking - South Bank TAFE", "2018"],
    ["Diploma of Sound Production and Audio Engineering - SAE Institute", "2011"]
  ],
  nextFocus: [
    {
